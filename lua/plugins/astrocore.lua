  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        ["]b"] = { function() require("astrocore.buffer").nav(vim.v.count1) end, desc = "Next history buffer" },
        ["[b"] = { function() require("astrocore.buffer").nav(-vim.v.count1) end, desc = "Previous history buffer" },
